...
md"""
## Setup Accounts
- Thanks if you already logged into Lynx cluster and got a GitHub account.
- If you haven't yet, pelase try before class on Friday.
- If you have trouble, please ask for help before Friday class.
"""
...
- ICDS clusters: Lynx, Roar Collab, LIGO,...
...
md"""
Packages like [LogarithmicNumbers.jl](https://github.com/cjdoris/LogarithmicNumbers.jl) or Package [LogExpFunction.jl](https://juliastats.org/Package [LogExpFunction.jl](https://juliastats.org/LogExpFunctions.jl/stable/) .jl/stable/) can help.
"""
...
# ╔═╡ c72e1905-bf29-49a7-a8ad-d5b86424032b
let
	a = exp(-746)
	b = exp(-747)
	logsumexp([a,b])
...
- Would using extended precision number help?
  + Julia Base: `BigFloat`  (included in Julia)
  * [QuadMath.jl](https://github.com/JuliaMath/Quadmath.jl): `Float128` (IEEE compliant, faster than BigFloat)
  + [DoubleFloats.jl](https://github.com/JuliaMath/DoubleFloats.jl): `Double64` (faster)
  + [MultiFloats.jl](https://docs.juliahub.com/MultiFloats/k11Ei/2.3.0/): `Float64x2`  (even faster)
  + [ArbNumerics.jl](https://github.com/JeffreySarnoff/ArbNumerics.jl): `ArbFloat{200}` (slow)
...
manifest_format = "2.0"
project_hash = "b572fdc5bfb4d43ad1b5a7b880f03adfe3c6a712"
...
version = "1.4.1"
    ...
    [deps.LogarithmicNumbers.weakdeps]
